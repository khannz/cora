package com.epam.cora.esa.service.lock;
...
public class LockService {
    ...
    public Optional<SimpleLock> getLock(final Long storageId) {
        // FIXME: refactor it to support latest shedlock
        return lockProvider.lock(new LockConfiguration("storage-index-" + storageId, LocalDateTime.now().plusMinutes(5L).toInstant(ZoneOffset.UTC)));
    }
