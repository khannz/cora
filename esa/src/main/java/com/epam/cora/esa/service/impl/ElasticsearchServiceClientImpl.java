...
public class ElasticsearchServiceClientImpl implements ElasticsearchServiceClient {
    ...
    public void createIndex(String indexName, String source) {
        ...
        try {
            ...
            Assert.isTrue(createIndexResponse.isAcknowledged(), "Create Elasticsearch index: " + createIndexResponse.toString());
        } catch (IOException e) {
    ...
    public BulkResponse sendRequests(String indexName, List<? extends DocWriteRequest> docWriteRequests) {
        ...
        try {
            ...
            Assert.isTrue(bulkResponse.status() == RestStatus.OK, "Failed to create Elasticsearch documents: " + bulkResponse.toString());
    ...
    public void deleteIndex(String indexName) {
        ...
        try {
            ...
            if (exception.status() == RestStatus.NOT_FOUND) {
                throw new ElasticsearchException("Response status " + RestStatus.NOT_FOUND + ": " + exception.getMessage(), exception);
            }
            throw new ElasticsearchException("Failed to delete Elasticsearch index: " + exception.getMessage(), exception);
        } catch (IOException e) {
    ...
    public void createIndexAlias(final String indexName, final String indexAlias) {
        ...
        AliasActions aliasAction = new AliasActions(AliasActions.Type.ADD).index(indexName).alias(indexAlias);
    ...
    public SearchResponse nextScrollPage(final String scrollId, final Scroll scroll) {
        ...
        try {
            ...
            throw new ElasticsearchException("Failed to retrieve next scroll page for [{}]: {}", scrollId, e.getMessage(), e);
        }
    }
