...
import com.epam.cora.entity.git.GitCredentials;
...
public class PipelineConfiguration {
    ...
    private static void putParamIfPresent(Map<String, String> params, String name, String value) {
        if (value != null) {
            params.put(name, value);
        }
    }

    private static void putParamIfPresent(Map<String, String> params, String name, Number value) {
        if (value != null) {
