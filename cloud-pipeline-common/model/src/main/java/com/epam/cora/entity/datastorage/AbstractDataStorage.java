...
@JsonSubTypes({@JsonSubTypes.Type(value = S3bucketDataStorage.class, name = "S3"), @JsonSubTypes.Type(value = AWSOmicsRefStorage.class, name = "AWS_OMICS_REF"), @JsonSubTypes.Type(value = AWSOmicsSeqStorage.class, name = "AWS_OMICS_SEQ"), @JsonSubTypes.Type(value = NFSDataStorage.class, name = "NFS"), @JsonSubTypes.Type(value = AzureBlobStorage.class, name = "AZ"), @JsonSubTypes.Type(value = GSBucketStorage.class, name = "GS"),})
public abstract class AbstractDataStorage extends AbstractSecuredEntity {
    ...
    public AbstractDataStorage(final Long id, final String name, final String path, final DataStorageType type) {
    ...
    public AbstractDataStorage(final Long id, final String name, final String path, final DataStorageType type, final StoragePolicy policy, final String mountPoint) {
        super(id, name);
        this.path = path;
        this.type = type;
